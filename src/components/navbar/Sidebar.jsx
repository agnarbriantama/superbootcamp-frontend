              ...
              <div className="flex items-center justify-start rtl:justify-end">
                ...
                <a href="" className="flex ms-2  md:me-24">
                  <img
                    ...
                    alt=""
                  />
                  <span className="self-center  whitespace-nowrap font-bold dark:text-white text-sm md:text-lg lg:text-x">
                    Book Store
                  </span>
                </a>
              </div>
              {userData ? (
                <div className="flex items-center">
                  <div className="flex items-center ms-3">
                    <div>
                      <div className=" flex flex-row font-bold mt-1  text-sm md:text-lg lg:text-xl ">
                        Hi, <span className="mr-4 ">{userData.nama}</span>
                        <span className="item-center">
                          <img
                            className=" h-10 mr-1 rounded-full shadow-lg"
            ...
            <ul className="space-y-2 font-medium">
              <li>
                ...
                >
                  ...
                  <span className="ms-3">Data Kategori</span>
                </Link>
              </li>
              <li>
                <Link
